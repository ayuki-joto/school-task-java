	...
	void run(String[] args)throws IOException{
 	...
 	void fainalscore(List<StudentID> student,List<Integer> taskscore,List<Integer> miniscore){
 		...
 		for(Integer i =0; i<student.size(); i++){
			...
			scorelist.add(score);
			if(score>=90) {
				System.out.println(student.get(i).id+", "+score+", "+student.get(i).score+", "+taskscore.get(i)+", "+miniscore.get(i)+" , 秀");
				grade.syuu++;
			}
			else if(score>=80) {
				System.out.println(student.get(i).id+", "+score+", "+student.get(i).score+", "+taskscore.get(i)+", "+miniscore.get(i)+" , 優");
				grade.yuu++;
			}		
			else if(student.get(i).score==0.0000) {
				System.out.println(student.get(i).id+", "+score+", "+student.get(i).score+", "+taskscore.get(i)+", "+miniscore.get(i)+" , K");
				grade.k++;
			}
			else if(score>=70) {
				System.out.println(student.get(i).id+", "+score+", "+student.get(i).score+", "+taskscore.get(i)+", "+miniscore.get(i)+" , 良");
				grade.ryou++;
			}
			else if(score>=60) {
				System.out.println(student.get(i).id+", "+score+", "+student.get(i).score+", "+taskscore.get(i)+", "+miniscore.get(i)+" , 可");
				grade.ka++;
			}
			else if(score<60) {
				System.out.println(student.get(i).id+", "+score+", "+student.get(i).score+", "+taskscore.get(i)+", "+miniscore.get(i)+" , 不可");
				grade.huka++;
			}	
		}
 	...
 	GradeChecker3 checker = new GradeChecker3();
 	checker.run(args);	
 	}
}